...
* Finally, *EOSFactory* works perfectly with [*Visual Studio Code*](https://code.visualstudio.com). To install it, please refer to [this webpage](https://code.visualstudio.com/download).
