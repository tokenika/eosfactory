...
set ( CONTEXT_DIR "${CMAKE_CURRENT_LIST_DIR}" )
message( STATUS "CONTEXT_DIR: ${CONTEXT_DIR}" )

if( WIN32 )
  set( CMAKE_INSTALL_PREFIX "${CONTEXT_DIR}/install/windows" )
  set( EOSIO_BINARY_DIR "${CONTEXT_DIR}/${EOS_FACTORY_EOS}/buildWindows" )
else( WIN32 )
  set( CMAKE_INSTALL_PREFIX "${CONTEXT_DIR}/install/ubuntu" )
  #set( EOSIO_BINARY_DIR "${CONTEXT_DIR}/${EOS_FACTORY_EOS}/build" )
