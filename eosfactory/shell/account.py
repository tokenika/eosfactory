...
class Account():
    ...
    def code(self, code=None, abi=None, wasm=True):
        ...
        self.code_result = GET_COMMANDS.GetCode(self, code, abi, wasm, is_verbose=False)
        logger.INFO("""
        * code()
        """)
    ...
    def set_account_permission(
        ...
        logger.TRACE("""
            * Set account permission.
            """)
        self.set_account_permission_result = SET_COMMANDS.SetAccountPermission(
    ...
    def set_action_permission(
        ...
        * Set action permission.
        ...
        self.set_action_permission_result = SET_COMMANDS.SetActionPermission(
                self, code, type, requirement,
                permission,
                expiration_sec, 
                skip_sign, dont_broadcast, return_packed, force_unique,
