...
import amaxfactory.core.testnet
...
def deploy(
    ...
    testnet_account = amaxfactory.core.testnet.get_testnet(testnet_account_name)
    if not testnet_account:
        raise errors.Error('''
        There is not any testnet account named '{}' in the list. 
        Use the bash command 
        `python3 -m amaxfactory.register_testnet -h`
...
def main():
    '''
    usage: python3 -m amaxfactory.deploy.py [-h] [--dir DIR] 
