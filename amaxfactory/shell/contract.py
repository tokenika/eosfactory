...
import amaxfactory.core.cleos_set as cleos_set
import amaxfactory.shell.account
...
class Contract(ContractBuilder):
    ...
    def __init__(
        ...
        if not isinstance(account, amaxfactory.shell.account.Account):
            raise errors.Error("""
            The account object has to be of the type 
            ``amaxfactory.shell.account.Account``.
            """)
