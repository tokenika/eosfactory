...
def main():
    '''
    usage: python3 -m amaxfactory.register_testnet [-h] \
    ...
    python3 -m amaxfactory.register_testnet http://jungle2.cryptolions.io:80 jungle 
    ...
    python3 -m amaxfactory.register_testnet http://jungle2.cryptolions.io:80 jungle -a
    ...
    Example:
        python3 -m amaxfactory.register_testnet.py http://jungle2.cryptolions.io:80 jungle
    ...
    # python3 amaxfactory.register_testnet http://88.99.97.30:38888 jungle -a dgxo1uyhoytn 5JE9XSurh4Bmdw8Ynz72Eh6ZCKrxf63SmQWKrYJSXf1dEnoiKFY 5JgLo7jZhmY4huDNXwExmaWQJqyS1hGZrnSjECcpWwGU25Ym8tA
