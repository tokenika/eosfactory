...
import amaxfactory.core.cleos_get as cleos_get
...
def reset(nodeos_stdout=None):
    ...
    the command line is printed, for *example*::
        ...
        --genesis-json /mnt/c/Workspaces/EOS/amaxfactory/localnode/genesis.json
        --delete-all-blocks
...
editor. Return ``None`` if the the offer is rejected.
    ...
    while True:
        ...
        or the corresponding method of any object of the 'amaxfactory.wallet.Wallet`
