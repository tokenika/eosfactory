...
class ORDERBOOKDEX(CreateAccount):
	...
	def buy(self,user='user1',sympair_id=1,quantity="0.10000000 AMAX",price="0.10000000 AMAX",ext_id=1,submitter_="admin",expect_asset=True):
		self.pushaction("buy",{"user":user,"sympair_id":sympair_id,"quantity":quantity,"price":price,"ext_id":ext_id,},submitter_,expect_asset=expect_asset) 
	...
	def delqueueord(self,user='user1',submitter_="admin",expect_asset=True):
		self.pushaction("delqueueord",{"user":user,},submitter_,expect_asset=expect_asset) 
	...
	def neworder(self,user='user1',sympair_id=1,order_side='user1',total_asset_quant="0.10000000 AMAX",price="0.10000000 AMAX",ext_id=1,order_config_ex=[],submitter_="admin",expect_asset=True):
		self.pushaction("neworder",{"user":user,"sympair_id":sympair_id,"order_side":order_side,"total_asset_quant":total_asset_quant,"price":price,"ext_id":ext_id,"order_config_ex":order_config_ex,},submitter_,expect_asset=expect_asset) 
	...
	def orderchange(self,queue_order_id=1,order_id=1,submitter_="admin",expect_asset=True):
		self.pushaction("orderchange",{"queue_order_id":queue_order_id,"order_id":order_id,},submitter_,expect_asset=expect_asset) 

	def sell(self,user='user1',sympair_id=1,quantity="0.10000000 AMAX",price="0.10000000 AMAX",ext_id=1,submitter_="admin",expect_asset=True):
		self.pushaction("sell",{"user":user,"sympair_id":sympair_id,"quantity":quantity,"price":price,"ext_id":ext_id,},submitter_,expect_asset=expect_asset) 
	...
	def setsympair(self,asset_symbol=[],coin_symbol=[],min_asset_quant="0.10000000 AMAX",min_coin_quant="0.10000000 AMAX",enabled='true',submitter_="admin",expect_asset=True):
		self.pushaction("setsympair",{"asset_symbol":asset_symbol,"coin_symbol":coin_symbol,"min_asset_quant":min_asset_quant,"min_coin_quant":min_coin_quant,"enabled":enabled,},submitter_,expect_asset=expect_asset) 
