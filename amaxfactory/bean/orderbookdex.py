...
class ORDERBOOKDEX(CreateAccount):
	...
	def settradepair(self,asset_symbol=[],coin_symbol=[],min_asset_quant="0.10000000 AMAX",min_coin_quant="0.10000000 AMAX",only_accept_coin_fee='true',enabled='true',submitter_="admin",expect_asset=True):
		self.pushaction("settradepair",{"asset_symbol":asset_symbol,"coin_symbol":coin_symbol,"min_asset_quant":min_asset_quant,"min_coin_quant":min_coin_quant,"only_accept_coin_fee":only_accept_coin_fee,"enabled":enabled,},submitter_,expect_asset=expect_asset) 
