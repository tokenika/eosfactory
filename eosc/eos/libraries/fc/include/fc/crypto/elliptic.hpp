  ...
  namespace ecc {
    ...
    */
    ...
    public:
      ...
      string str() const;
      string to_base58() const { return str(); }
      static extended_public_key from_base58(const string& base58);
    ...
    public:
      ...
      string str() const;
      string to_base58() const { return str(); }
      static extended_private_key from_base58(const string& base58);
      static extended_private_key generate_master(const string& seed);
    ...
    blind_factor_type blind_sum(const vector<blind_factor_type>& blinds, uint32_t non_neg);
    /**  verifies taht commnits + neg_commits + excess == 0 */
    //bool            verify_sum(const vector<commitment_type>& commits, const std::vector<commitment_type>& neg_commits, int64_t excess);
