EOS Factory is a smart-contract development framework, made by [Tokenika](https://tokenika.io/) for compiling, testing and deploying [EOS](https://eos.io/) smart-contracts.
