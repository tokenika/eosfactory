#!/bin/bash
##########################################################################
# This script instals tokenika 'eosfactory' into Linux and Mac OS.
...
# 	export EOS_BUILD_TYPE=[Debug|Release|RelWithDebInfo|MinSizeRel|CodeCoverage] to enable
	...
	$CMAKE -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_CXX_COMPILER="g++-7" \
	-DCMAKE_C_COMPILER="gcc-7" -DWASM_ROOT=${WASM_ROOT} \
	-DOPENSSL_ROOT_DIR=${OPENSSL_ROOT_DIR} -DBUILD_MONGO_DB_PLUGIN=true \
	-DECC_IMPL="openssl" \
	..
