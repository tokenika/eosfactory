...
DEFINE_INTRINSIC_FUNCTION2(env,multeq_i128,multeq_i128,none,i32,self,i32,other) {
   ...
   */
   ///tokenika:
   auto& v = memoryRef<boost_uint128>( mem, self );
   const auto& o = memoryRef<const boost_uint128>( mem, other );
   ///tokenika
   v *= o;
}
...
DEFINE_INTRINSIC_FUNCTION1(env,printi128,printi128,none,i32,val) {
  ...
  */
  ...
  //TO DO: I am not quite sure about the following:
  ///tokenika:
  boost_uint128 value = memoryRef<boost_uint128>( mem, val );
  std::cerr << value;
  ///tokenika
}
