...
EOSFactory offers another debugging tool: printing requests send by `cleos` to nodeos, and responses from nodeos. For example, if deployment of the contract in the test script 01_hello_world.py fails, modify the script:
