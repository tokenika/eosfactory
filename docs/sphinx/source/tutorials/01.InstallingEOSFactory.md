...
* We assume that you have successfully installed *EOSIO* [v1.2.0](https://github.com/EOSIO/eos/releases/tag/v1.2.0) (or higher) on your machine. If that's not the case, please refer to [this guide](https://github.com/EOSIO/eos/wiki/Local-Environment).
...
- We also assume that you have successfully installed *EOSIO* [v1.2.0](https://github.com/EOSIO/eos/releases/tag/v1.2.0) (or higher) on your machine. If that's not the case, please refer to [this guide](https://github.com/EOSIO/eos/wiki/Local-Environment).
