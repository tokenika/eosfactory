...
**NOTE:** EOSFactory is now compatible with the latest release of *EOSIO*, tagged as `v1.0.7`, and from now on we expect it to be fully compatible with subsequent *EOSIO* releases.
