...
All the articles are going to be expressed in the framework of the [EOSIDE](https://eosfactory.io/eoside/html/index.html) which is an Integrated Development Environment, in the terms of [EOSFactory](https://eosfactory.io/build/html/index.html) API, and they are going to be mutually compatible.

Exemplary origin of this knowledge base is in [`docs/cases`](https://eosfactory.io/build/html/index.html#use-cases) and [`docs/patterns`](https://eosfactory.io/build/html/index.html#patterns) directories of EOSFactory repository.
