# EOSFactory Release Notes - v3.0.2

## Compatibility

EOSFactory [v3.0.2](https://github.com/tokenika/eosfactory/releases/tag/v3.0.2) is compatible with EOS [v1.6.0](https://github.com/EOSIO/eos/releases/tag/v1.6.0) and eosio.cdt [v1.5.0](https://github.com/EOSIO/eosio.cdt/releases/tag/v1.5.0).
