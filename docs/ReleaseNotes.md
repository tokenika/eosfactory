# EOSFactory Release Notes - v3.0.3

## Compatibility

EOSFactory [v3.0.3](https://github.com/tokenika/eosfactory/releases/tag/v3.0.3) is compatible with EOS [v1.6.0](https://github.com/EOSIO/eos/releases/tag/v1.6.0) and eosio.cdt [v1.5.0](https://github.com/EOSIO/eosio.cdt/releases/tag/v1.5.0).
